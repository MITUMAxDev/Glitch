--[[
    // CREDIT \\
This library made by Dummy one of Glitch Team
If you're looking for free UI Library go check his discord server
https://discord.gg/QbCv7uzgT6

( Most Library is Open Source just like this one )
]]--
...
local themes = {
	index = {'Dark', 'Amethyst', 'Glitch'},
	Glitch = {
	['Shadow'] = Color3.fromRGB(20, 10, 40),
	['Background'] = Color3.fromRGB(25, 15, 45),
	['Page'] = Color3.fromRGB(18, 10, 36),
	['Main'] = Color3.fromRGB(165, 90, 255), -- สีม่วงสด
	['Text & Icon'] = Color3.fromRGB(255, 220, 255),
	['Function'] = {
		['Toggle'] = {
			['Background'] = Color3.fromRGB(30, 20, 50),
			['True'] = {
				['Toggle Background'] = Color3.fromRGB(90, 40, 130),
				['Toggle Value'] = Color3.fromRGB(165, 90, 255),
			},
			['False'] = {
				['Toggle Background'] = Color3.fromRGB(45, 25, 70),
				['Toggle Value'] = Color3.fromRGB(60, 35, 90),
			}
		},
		['Label'] = {
			['Background'] = Color3.fromRGB(30, 20, 50),
		...
		['Dropdown'] = {
			['Background'] = Color3.fromRGB(30, 20, 50),
			['Value Background'] = Color3.fromRGB(25, 15, 45),
			['Value Stroke'] = Color3.fromRGB(255, 220, 255),
			['Dropdown Select'] = {
				['Background'] = Color3.fromRGB(25, 15, 45),
				['Search'] = Color3.fromRGB(40, 25, 65),
				['Item Background'] = Color3.fromRGB(55, 30, 80),
			}
		},
		['Slider'] = {
			['Background'] = Color3.fromRGB(30, 20, 50),
			['Value Background'] = Color3.fromRGB(25, 15, 45),
			['Value Stroke'] = Color3.fromRGB(255, 220, 255),
			['Slider Bar'] = Color3.fromRGB(90, 40, 130),
			['Slider Bar Value'] = Color3.fromRGB(165, 90, 255),
		...
		['Code'] = {
			...
			['Background Code'] = Color3.fromRGB(80, 50, 110),
			['Background Code Value'] = Color3.fromRGB(55, 35, 80),
			['ScrollingFrame Code'] = Color3.fromRGB(200, 120, 255)
		},
		['Button'] = {
			['Background'] = Color3.fromRGB(30, 20, 50),
		...
		['Color Picker'] = {
			...
			['Color Select'] = {
				['Background'] = Color3.fromRGB(25, 15, 45),
				['UIStroke'] = Color3.fromRGB(255, 220, 255),
			}
		}
	}
},
